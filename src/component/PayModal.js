        ...
        <div className="pay-modal">
            ...
            <div className="pay-container">
                    ...
                    <div className="order-info">
                        ...
                        <div>
                            ...
                            <div className="quantity-control">
                                <button className="quantity-button" onClick={() => handleQuantityChange("minus")}>
                                    -
                                </button>
                                <div className="quantity">{quantity}</div>
                                <button className="quantity-button" onClick={() => handleQuantityChange("plus")}>
                                    +
                                </button>
                            </div>
                        </div>
                ...
                <div className="section">
                    ...
                    <div className="user-info">010-2009-1936</div>
                    <div className="user-info">
                        경기도 고양시 덕양구 항공대학로 76 국제은익관 1생활관 M330
                    </div>
                </div>
